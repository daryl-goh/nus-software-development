...
4. git add * (add new/updated files to be committed into local repo)

5. git status (to check files that are going to commit into local repo)

6. git commit -m "<commit mesage>" (commit new/updated files to local repo)
...
9. git remote -v (all remote branches and you should see reference URL to heroku)
