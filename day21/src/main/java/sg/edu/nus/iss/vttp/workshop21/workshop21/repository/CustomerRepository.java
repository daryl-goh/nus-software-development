package sg.edu.nus.iss.vttp.workshop21.workshop21.repository;

/**
 * https://www.geeksforgeeks.org/java-jdbc-difference-between-row-set-and-result-set/
 */
import static sg.edu.nus.iss.vttp.workshop21.workshop21.repository.Queries.*;

import java.util.LinkedList;
import java.util.List;

import sg.edu.nus.iss.vttp.workshop21.workshop21.models.Customer;
import sg.edu.nus.iss.vttp.workshop21.workshop21.models.CustomerRowMapper;
import sg.edu.nus.iss.vttp.workshop21.workshop21.models.Order;
